...
AGENTS: list[Agent] = [
    Agent(
        ...
        status="active",
        prompt="You are a dental reception assistant. Confirm caller identity, gather appointment intent, and keep replies concise.",
        prompt_version="v1.8",
    ...
    Agent(
        ...
        status="active",
        prompt="You are a retention specialist. Recover missed appointments, offer next available slot, and escalate billing questions.",
        prompt_version="v1.4",
    ...
    Agent(
        ...
        status="offline",
        prompt="You are a dealership lead qualifier. Capture budget, timeline, and model preference before routing to sales.",
        prompt_version="v0.9",
    ...
    Agent(
        ...
        status="error",
        prompt="You are an intake assistant for legal screening. Collect case type, urgency, and preferred callback details.",
        prompt_version="v1.2",
